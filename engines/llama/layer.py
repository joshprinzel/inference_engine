...
from engines.llama.attention import llama_attention_with_output_projection
...
def llama_decoder_layer_forward(
        ...
        attention_scaling: torch.Tensor | None = None,
) -> torch.Tensor:
    """
    Sinlge Llama decoder layer forward pass.
    ...
    attn_out = llama_attention_with_output_projection(
        q=q_rot,
        k=k_rot,
        v=v_heads,
